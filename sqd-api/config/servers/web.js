  ...
  servers: {
    web: function(api){
      var config = {
        ...
        serverOptions: {},
        // Port or Socket Path
        port: process.env.SQD_PORT || 8080,
        ...
        httpHeaders : {
          ...
          'Access-Control-Allow-Headers': 'Content-Type, Token, Sqdversion, Cache-Control'
        },
      ...
      if(process.env.ACTIONHERO_ROLE === 'fileServer'){
        config.port = process.env.SQD_PORT_FILE;
      }
