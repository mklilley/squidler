exports['default'] = {
  general: function(api){
    return {
      ...
      welcomeMessage: 'Hello! Welcome to the Squidler api',
      // the redis prefix for actionhero's cache objects
      cachePrefix: 'sqd:cache:',
...
exports.production = {
  general: function(api){
    return {
      ...
      serverToken: process.env.SQD_SERVER_TOKEN,
      filteredParams:["email","token"]
    };
  }
};
